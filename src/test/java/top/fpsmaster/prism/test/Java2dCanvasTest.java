...
class Java2dCanvasTest {
    ...
    void panelPaintsOpaquePixels() {
        ...
        UiHost host = new UiHost() {
            public top.fpsmaster.prism.canvas.Canvas canvas() {
                return canvas;
            }
            ...
            public top.fpsmaster.prism.canvas.FontHandle font(int size) {
            ...
            public top.fpsmaster.prism.canvas.ImageHandle image(String id) {
                return null;
            }
        };
